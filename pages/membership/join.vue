  ...
  <view class="page">
    ...
    <view class="content">
      ...
      <button class="pay" :disabled="!selected || paying" :loading="paying" @click="pay">
        {{ selected ? `微信支付 ¥${selected.amount}` : '请选择会员方案' }}
      </button>
...
export default {
  data() {
    return { plans: [], selected: null, paying: false }
  },
  onLoad() {
    this.load()
  },
