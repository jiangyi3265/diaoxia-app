...
export default {
  ...
  computed: {
    ...
    statusNote() {
      return { BOOKED: '请按预约时段到店，向工作人员出示会员码完成签到', CHECKED_IN: '签到已完成，请前往对应座位', CANCELED: '预约已取消，不再占用座位', NO_SHOW: '预约时段已结束' }[this.item.status] || '预约状态已更新'
    }
  },
